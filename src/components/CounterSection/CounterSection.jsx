                ...
                <div className="row">
                    <div className="col-sm-6 col-lg-6">
                        <div className="counter-box counter-box pt-4 pt-md-0">
                            ...
                            <div className="counter-num">
                                <CountUp start={0} end={countersInView ? 15 : 0} duration={2} className="counter purecounter" />
                    ...
                    <div className="col-sm-6 col-lg-6">
                        <div className="counter-box pt-4 pt-md-0">
                            ...
                            <div className="counter-num">
                                <CountUp start={0} end={countersInView ? 2 : 0} duration={2} className="counter purecounter" />
                ...
                <div className="row">
                    <div className="col-sm-6 col-lg-6">
                        <div className="counter-box counter-box pt-4 pt-md-0">
                            ...
                            <div className="counter-num">
                                <CountUp start={0} end={countersInView ? 12 : 0} duration={2} className="counter purecounter" />
                                <p className="counter-text">WORKS COMPLETED</p>
                            </div>
                        </div>
                    </div>
